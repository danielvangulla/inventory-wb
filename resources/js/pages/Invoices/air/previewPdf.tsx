...
const PreviewPdf: React.FC<PreviewPdfProps> = ({ isGuest, invoice, downloadPDF, closeModal }) => {
    return (
        <div className="bg-white p-2 rounded shadow-md w-full md:w-2/3 max-w-2xl mx-2">
            <div className='flex justify-center items-center bg-blue-100 text-black px-1 py-4 rounded-t text-xs'>
                ...
                <table className="mx-2">
                    <tbody>
                        ...
                        <tr >
                            <td className="text-left pl-4" colSpan={3}>{invoice.meter_air?.tenant_book?.nama_toko}</td>
                        ...
                        <tr >
                            <td className="text-left pl-4 max-w-3xs" colSpan={3}>{invoice.meter_air?.tenant_book?.perusahaan}</td>
                        ...
                        <tr >
                            <td className="text-left pl-4 pr-4 max-w-3xs" colSpan={3}>{invoice.meter_air?.tenant_book?.alamat}</td>
                        </tr>
                        <tr>
                        ...
                        <tr >
                            ...
                            <td className="text-left whitespace-nowrap">
                                Lt.{invoice.meter_air?.tenant_book?.tenant?.floor} #{invoice.meter_air?.tenant_book?.tenant?.no}
                            </td>
                        </tr>
                    </tbody>
                </table>
                ...
                <table className="min-w-full border-collapse">
                    <thead className="border-y border-l border-r border-gray-300 text-md">
                        <tr>
                            ...
                            <th className="px-2 py-1 text-center">Awal <br />(m³)</th>
                            <th className="px-2 py-1 text-center">Akhir <br />(m³)</th>
                            <th className="px-2 py-1 text-center">Pemakaian <br />(m³)</th>
                            <th className="px-2 py-1 text-center">Tarif <br />per m³</th>
                    ...
                    <tbody className="border-y border-l border-r border-gray-300">
                        <tr className='hover:bg-gray-100'>
                            ...
                            <td className="px-2 text-center">{formatDigit(invoice.meter_air?.awal || 0, 2)} m³</td>
                            <td className="px-2 text-center">{formatDigit(invoice.meter_air?.akhir || 0, 2)} m³</td>
                            <td className="px-2 text-center">{formatDigit(invoice.pemakaian || 0, 2)} m³</td>
                            <td className="px-2 text-center"></td>
                            <td className="px-2 text-right"></td>
                        </tr>

                        {invoice.air_invoice_details?.map((detail, index) => (
                            <tr key={index} className='hover:bg-gray-100'>
                                <td className="px-2 text-left" colSpan={3}>{detail.ket}</td>
                                <td className="px-2 text-center">{formatDigit(detail.volume, 2)} m³</td>
                                <td className="px-2 text-center">{formatDigit(detail.tarif, 2)}</td>
                                <td className="px-2 text-right">{formatUang(detail.jumlah)}</td>
                            </tr>
                        ))}

                        <tr className='hover:bg-gray-100'>
                            <td className="px-2 text-left">Biaya Admin</td>
                            <td className="px-2 text-right"></td>
                            <td className="px-2 text-right"></td>
                            <td className="px-2 text-right"></td>
                            <td className="px-2 text-right"></td>
                        ...
                        {invoice.biaya_lain > 0 &&
                            <tr className='hover:bg-gray-100'>
                                <td className="px-2 text-left">Biaya Lain</td>
                                <td className="px-2 text-right"></td>
                                <td className="px-2 text-right"></td>
                                <td className="px-2 text-right"></td>
                                <td className="px-2 text-right"></td>
                        ...
                        {invoice.denda > 0 &&
                            <tr className='hover:bg-gray-100'>
                                <td className="px-2 text-left">Denda</td>
                                <td className="px-2 text-right"></td>
                                <td className="px-2 text-right"></td>
                                <td className="px-2 text-right"></td>
                                <td className="px-2 text-right"></td>
