...
const LaporanHutangLunas: React.FC<Props> = ({ data, suppliers, params }) => {
    ...
    const handleFilterByTanggal = (tgl1: string, tgl2: string) => {
        ...
        router.visit(`/inventory/laporan-hutang-lunas`, {
            method: 'post',
            data: {
                tgl1: tgl1,
                tgl2: tgl2,
        ...
        <AppLayout breadcrumbs={breadcrumbs}>
            ...
            <div className="w-full px-4 py-2 max-w-lg md:max-w-xl lg:max-w-3xl xl:max-w-5xl 2xl:max-w-full mx-auto">
                ...
                <div className="w-full overflow-x-auto h-full text-sm mt-4">
                    <HutangxLunasTable filteredData={filteredData} />
                </div>
            </div>
        </AppLayout>
    );
...
export default LaporanHutangLunas;
