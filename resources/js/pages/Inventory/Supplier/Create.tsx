...
const Create: React.FC = () => {
    const breadcrumbs = [
        {
            ...
            href: "/inventory/suppliers/create",
        },
    ];
    ...
    const handleSubmit = async () => {
        if (formData.nama.trim() === "") {
            setError("Silahkan isi nama supplier..");
            return;
        }
        ...
        try {
            ...
            router.post(route("inventory.suppliers.store"), payload, {
                onSuccess: () => {
                    setSuccess(true);
                ...
                <div className="space-y-4 bg-gray-200 p-4 rounded shadow">
                    ...
                    <div className="flex flex-col justify-center gap-4 py-4 px-2 bg-gray-100 dark:bg-gray-700 rounded-lg border-2 border-black dark:border-gray-600">
                        ...
                        <div className="flex flex-col">
                            <label className="text-sm font-medium text-gray-700 dark:text-gray-300 mb-1 pl-1">Nama Supplier</label>
                            <input
                                type="text"
                                value={formData.nama}
                    ...
                    {success && <div className="text-green-600">Supplier berhasil dibuat!</div>}
