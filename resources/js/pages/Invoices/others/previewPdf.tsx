            ...
            <div className='flex justify-center items-center bg-blue-100 text-black px-1 py-2 rounded-t text-xs'>
                ...
                <table className="mx-2">
                    <tbody>
                        ...
                        <tr >
                            <td className="text-left pl-4" colSpan={3}>{invoice.tenant_book?.nama_toko || invoice.tenant_nama}</td>
                        ...
                        <tr >
                            ...
                            <td className="text-left pl-4 whitespace-nowrap"><b>Unit</b></td>
                            <td className="text-center" width={15}>:</td>
                            <td className="text-left whitespace-nowrap">Lt. {ltUnit} {noUnit}</td>
                        </tr>
                    </tbody>
                </table>
            ...
            <div className='flex justify-center items-center bg-blue-100 text-black pt-1 px-2 lg:px-12 text-xs font-mono'>
                <table className="min-w-full border-collapse">
                    ...
                    <tbody className="border-y border-l border-r border-gray-300">
                        {invoice.details?.map((v) => (
                            <tr className='hover:bg-gray-100' key={v.id}>
                                <td className="px-2 text-left w-full">{v.keterangan}</td>
                                <td className="px-2 text-left"></td>
                                <td className="px-2 flex justify-between"> <span className="pl-4">Rp.</span> {formatUang(v.jumlah)}</td>
                            </tr>
                        ))}
