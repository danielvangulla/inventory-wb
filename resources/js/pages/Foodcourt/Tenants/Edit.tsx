...
const Edit: React.FC<Props> = ({ tenant }) => {
    const breadcrumbs = [
        {
            title: "Edit Tenant",
    ...
    const handleSubmit = async () => {
        ...
        try {
            router.patch(route("foodcourt.tenants.update", tenant.id), { ...formData }, {
                onSuccess: () => {
                    setSuccess(true);
        ...
        <AppLayout breadcrumbs={breadcrumbs}>
            ...
            <div className="container mx-auto max-w-xl p-2">
                <div className="mb-6 flex flex-row items-center pt-2">
                    <h1 className="text-xl font-bold">Edit Tenant</h1>
                </div>
                ...
                <div className="space-y-4 bg-gray-200 p-4 rounded shadow">
                    ...
                    <div className="flex flex-wrap justify-center gap-4 py-4 bg-gray-100 dark:bg-gray-700 rounded-lg border-2 border-black dark:border-gray-600">
                        ...
                        <div className="flex flex-col">
                            <label className="text-sm font-medium text-gray-700 dark:text-gray-300 mb-1 pl-1">Nama Tenant</label>
                            <input
                                type="text"
                        ...
                        {/* Owner */}
                        <div className="flex flex-col">
                            <label className="text-sm font-medium text-gray-700 dark:text-gray-300 mb-1 pl-1">Owner</label>
                            <input
                                type="text"
                        ...
                        {/* Telp / HP */}
                        <div className="flex flex-col">
                            <label className="text-sm font-medium text-gray-700 dark:text-gray-300 mb-1 pl-1">Telp / HP</label>
                            <input
                                type="text"
                                value={formData.hp || ''}
                        ...
                        {/* IP Printer */}
                        <div className="flex flex-col">
                            <label className="text-sm font-medium text-gray-700 dark:text-gray-300 mb-1 pl-1">IP Printer</label>
                            <input
                                type="text"
                                value={formData.ip_printer || ''}
                                onChange={(e => setFormData({ ...formData, ip_printer: e.target.value }))}
                                className="w-full text-center rounded-md border border-gray-300 dark:border-gray-600 bg-white dark:bg-gray-800 text-gray-800 dark:text-white p-2 focus:outline-none focus:ring-2 focus:ring-blue-500"
                            />
                        </div>
                    </div>

                    {error && <div className="text-red-600">{error}</div>}
                    {success && <div className="text-green-600">Tenant berhasil diperbarui!</div>}
