...
const Edit: React.FC<Props> = ({ outlet }) => {
    const breadcrumbs = [
        {
            title: "Edit Outlet",
            href: `/inventory/outlets/${outlet.id}/edit`,
        },
    ];
    ...
    const handleSubmit = async () => {
        ...
        try {
            router.patch(route("inventory.outlets.update", outlet.id), { ...formData }, {
                onSuccess: () => {
                    setSuccess(true);
        ...
        <AppLayout breadcrumbs={breadcrumbs}>
            ...
            <div className="container mx-auto max-w-xl p-2">
                <div className="mb-6 flex flex-row items-center pt-2">
                    <h1 className="text-xl font-bold">Edit Outlet</h1>
                </div>
                ...
                <div className="space-y-4 bg-gray-200 p-4 rounded shadow">
                    ...
                    {success && <div className="text-green-600">Outlet berhasil diperbarui!</div>}
