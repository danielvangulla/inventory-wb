                ...
                <table className="mx-2">
                    <tbody>
                        ...
                        <tr >
                            ...
                            <td className="text-center" width={15}>:</td>
                            <td className="text-left whitespace-nowrap">Lt.{invoice.floor} #{invoice.unit}</td>
                        </tr>
                    </tbody>
                </table>
                ...
                <table className="min-w-full border-collapse">
                    ...
                    <tbody className="border-y border-l border-r border-gray-300">
                        <tr className='hover:bg-gray-100'>
                            <td className="px-2 text-left pt-1">{invoice.keterangan}</td>
                            <td className="px-2 text-right">Rp.</td>
                            <td className="px-2 text-right">{formatUang(invoice.jumlah)}</td>
                        </tr>

                        <tr className='hover:bg-gray-100'>
                            <td className="px-2 text-left">Promotion Levy ({formatUang(invoice.promotion_levy_persen)}%)</td>
                            <td className="px-2 text-right"></td>
                            <td className="px-2 text-right">{formatUang(invoice.promotion_levy_jumlah)}</td>
                        </tr>

                        {invoice.diskon_jumlah && invoice.diskon_jumlah > 0 &&
                            <tr className='hover:bg-gray-100'>
                        ...
                        {invoice.biaya_jumlah && invoice.biaya_jumlah > 0 &&
                            <tr className='hover:bg-gray-100'>
                    ...
                    <tfoot className="border-y border-l border-r border-gray-300">
                        <tr className='hover:bg-gray-100 font-bold text-md'>
                            ...
                            <td className="px-2 py-1 text-right">{formatUang(invoice.total)}</td>
                        </tr>
                    </tfoot>
                </table>
                <br />
