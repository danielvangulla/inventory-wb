                                    ...
                                    <td className="py-2 px-2 text-left border border-black dark:border-gray-400">
                                        {v.details && v.details.map((detail, i) => (
                                            <div key={i} className="flex flex-row justify-between">
                                                ...
                                                <span>{formatDigit(detail.qty, 0)} {detail.barang?.satuan} x {formatDigit(detail.harga, 0)} = {formatDigit(detail.brutto, 0)}</span>
                                            </div>
                                        ))}
                                    </td>
                                    <td className="py-2 px-2 text-right border border-black dark:border-gray-400">{formatDigit(v.total, 0)}</td>
