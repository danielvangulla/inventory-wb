...
const Index: React.FC<Props> = ({ tenants }) => {
    ...
    return (
        <AppLayout breadcrumbs={breadcrumbs}>
            ...
            <div className="mt-2 px-4 py-4 max-w-lg md:max-w-xl lg:max-w-3xl xl:max-w-5xl 2xl:max-w-full mx-auto bg-amber-100 rounded-lg shadow-md">
                <div className="flex flex-col justify-center items-center bg-transparent rounded-lg shadow-md border-2 border-red-500 mb-4">
                    <img src="/images/desain-paragon.jpeg" alt="FoodCourt Logo" className="relative w-full h-80 object-cover rounded-md blur-xs" />
                    ...
                    <div className="absolute flex flex-col justify-center items-center">
                        ...
                        <div className="flex flex-col justify-center items-center text-4xl text-center font-bold mb-4 bg-white text-blue-500 shadow-md shadow-purple-400 rounded-xl border-2 border-red-300 p-2 z-10">
                            PARAGON SQUARE <br />
                            <span className="text-red-400">FOOD COURT</span>
                        </div>
                    </div>
                </div>
                ...
                <div className="mt-6 text-center text-sm text-gray-500">
                    &copy; {new Date().getFullYear()} Paragon Square Food Court. All rights reserved.
                </div>
            </div>
