...
const Edit: React.FC<Props> = ({ level }) => {
    ...
    const handleSubmit = async () => {
        ...
        try {
            router.patch(route("inventory.user-level.update", level.id), { ...formData }, {
                onSuccess: () => {
                    setSuccess(true);
                    setFormData(level);
                },
                        ...
                        <div className="flex flex-col justify-center items-center w-full gap-2 md:w-auto p-1">
                            ...
                            <div className="flex flex-row justify-center gap-4 flex-wrap">
                                ...
                                <div
                                    ...
                                    className="flex flex-col justify-center items-center p-2 border border-gray-300 dark:border-gray-600 rounded-lg bg-white hover:bg-gray-100 dark:bg-gray-800 cursor-pointer text-center">
                                    <div className="flex items-center space-x-2">
                                        <label className="text-sm font-medium text-gray-700 dark:text-gray-300 mb-1 pl-1">Barang Read</label>
                                        <input
                                            type="checkbox"
                                ...
                                <div
                                    ...
                                    className="flex flex-col justify-center items-center p-2 border border-gray-300 dark:border-gray-600 rounded-lg bg-white hover:bg-gray-100 dark:bg-gray-800 cursor-pointer text-center">
                                    <div className="flex items-center space-x-2">
                                        <label className="text-sm font-medium text-gray-700 dark:text-gray-300 mb-1 pl-1">Barang Write</label>
                                        <input
                                            type="checkbox"
