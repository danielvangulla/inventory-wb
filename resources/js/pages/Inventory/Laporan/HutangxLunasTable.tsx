        ...
        <table className="bg-white shadow-md rounded-md min-w-full">
            <thead>
                <tr className="bg-gray-300 border border-gray-300">
                    ...
                    <th className="py-2 px-2 text-center border border-black w-28" rowSpan={2}>Tanggal <br />Lunas</th>
            ...
            <tbody>
                ...
                {filteredData.length > 0 && filteredData.map((v, index) => (
                    <tr key={v.id} className='hover:bg-blue-300'>
                        ...
                        <td className="py-2 px-2 text-center border border-black whitespace-nowrap">{formatTgl(v.tgl_lunas || '')}</td>
            ...
            <tfoot>
                <tr className='bg-blue-200 text-lg font-bold'>
                    <td colSpan={9} className="py-2 px-2 text-right border border-black font-bold">Total Pelunasan</td>
