                        ...
                        <table className="divide-y divide-gray-200 w-full border border-black dark:border-gray-400">
                                        ...
                                        return (
                                            <tr key={index}>
                                                ...
                                                <td className="px-2 py-1 text-center border border-black dark:border-gray-400">
                                                    {formatDigit(detail.qty, 0)} {barang ? barang.satuan : ""}
                                                </td>
                                                <td className="px-2 py-1 text-right border border-black dark:border-gray-400">{formatDigit(detail.harga, 0)}</td>
                                                <td className="px-2 py-1 text-right border border-black dark:border-gray-400">{formatDigit(detail.brutto, 0)}</td>
                                            </tr>
                                        );
                                    })
                                ) : (
                            ...
                            <tfoot className="bg-blue-500 text-md text-white">
                                <tr>
                                    ...
                                    <td className="px-2 py-2 text-right font-bold border border-black dark:border-gray-400">{formData.total.toLocaleString()}</td>
                                </tr>
                            </tfoot>
                        </table>
                    </div>
                        ...
                        <div className="flex flex-col lg:flex-row justify-center items-center gap-2 pt-2">
                            ...
                            <div className="flex flex-row lg:flex-col items-center lg:items-start justify-center gap-2 lg:gap-0 md:min-w-20 max-w-full bg-gray-100 p-1 rounded-lg">
                                ...
                                <input
                                    type="text"
                                    placeholder="Qty"
                                    value={formatDigit(item?.qty || 0, 0)}
                            ...
                            <div className="flex flex-row lg:flex-col items-center lg:items-start justify-center gap-2 lg:gap-0 md:min-w-24 max-w-full bg-gray-100 p-1 rounded-lg">
                                ...
                                <input
                                    type="text"
                                    placeholder="Harga"
                                    value={formatDigit(item?.harga || 0, 0)}
